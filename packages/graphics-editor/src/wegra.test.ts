...
const legacyV1Fixture =
  "";

function fixtureBytes() {
  return Uint8Array.from(atob(legacyV1Fixture), c => c.charCodeAt(0));
}
...
describe("WEGRA serialization", () => {
  it("canonicalizes object keys recursively while preserving array order", () => {
    ...
    ).toBe('{"a":{"b":1,"d":2},"items":[{"a":1,"z":0},{"a":3,"b":2}],"z":1}');
  });
  ...
  it("migrates a v1 manifest to the current version", () => {
    const manifest = migrateWegraManifest({
      format: "wegra",
      version: 1,
      document: "document.json",
      history: true,
      provenance: "provenance/actors.json",
      assets: ["assets/b", "assets/a", "assets/a"],
    });
  ...
  it("rejects future versions", () => {
    expect(() => migrateWegraManifest({ format: "wegra", version: WEGRA_VERSION + 1 })).toThrow(
      "Unsupported WEGRA version",
    );
  });
