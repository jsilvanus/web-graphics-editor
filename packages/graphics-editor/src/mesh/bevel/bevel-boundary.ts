...
export function buildBoundaryBevel(
  ...
  indices[base] = inner[0];
  indices[base + 1] = inner[1];
  indices[base + 2] = inner[2];
...
function point(mesh: Graphics3DMesh, i: number): Vec3 {
  return [
