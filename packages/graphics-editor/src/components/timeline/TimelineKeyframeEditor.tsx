...
export const TimelineKeyframeEditor: FC<TimelineKeyframeEditorProps> = ({
  value,
  onTimeChange,
  onValueChange,
  onEasingChange,
  ...
  return (
    <div className="ge-key-editor">
      ...
      <label>
        Easing
        <select value={easing} onChange={e => onEasingChange(e.target.value as Easing)}>
          {allowed.map(([v, label]) => (
