...
export const SceneTimelineHeader: FC<SceneTimelineHeaderProps> = ({
  currentTime,
  total,
  loop,
  onSeek,
  ...
  <div className="ge-timeline-head">
    ...
    <label>
      <input type="checkbox" checked={loop} onChange={e => onLoopChange(e.target.checked)} /> Loop
    </label>
    <button title="Duplicate the complete timeline after itself" onClick={onDuplicate}>
      ⧉ Duplicate timeline
    </button>
    <span>
