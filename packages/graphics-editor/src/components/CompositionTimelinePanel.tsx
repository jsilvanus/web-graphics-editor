...
export const CompositionTimelinePanel: FC<{
 ...
 return <section className="ge-timeline" aria-label="Composition timeline">
  ...
  <div className="ge-timeline-body" style={{position:"relative"}} onPointerDown={scrub}><div aria-hidden="true" style={{position:"absolute",left:`${Math.max(0,Math.min(100,currentTime/total*100))}%`,top:0,bottom:0,width:2,background:"currentColor",zIndex:20,pointerEvents:"none"}} />
