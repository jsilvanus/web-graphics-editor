...
export const GroupLayerRenderer: FC<GroupLayerRendererProps> = ({ layer, layers, selectedIds, worlds3d, views3d, currentTime = 0, onLayerPointerDown, onSelectLayer, onPathNodes }) => {
