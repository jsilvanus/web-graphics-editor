...
}> = ({ layer, layers = [], selected, selectedIds = new Set(), multiSelected, onPointerDown, onLayerPointerDown, onNodes, worlds3d = [], views3d = [] }) => {
  const content = <CanvasLayerContent layer={layer} layers={layers} selected={selected} selectedIds={selectedIds} multiSelected={multiSelected} onPointerDown={onPointerDown} onLayerPointerDown={onLayerPointerDown} onNodes={onNodes} worlds3d={worlds3d} views3d={views3d} />;
