...
}> = ({ layer, selected, multiSelected, onPointerDown, onNodes, worlds3d = [], views3d = [] }) => {
  const content = <CanvasLayerContent layer={layer} selected={selected} multiSelected={multiSelected} onPointerDown={onPointerDown} onNodes={onNodes} worlds3d={worlds3d} views3d={views3d} />;
