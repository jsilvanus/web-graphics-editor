...
export const CanvasLayer:FC<{layer:Layer;selected:boolean;multiSelected:boolean;onPointerDown:(event:ReactPointerEvent,kind:"move"|"resize"|"rotate",handle?:string)=>void;onNodes?:(nodes:PathNode[])=>void;worlds3d?:Graphics3DWorld[];views3d?:Graphics3DView[]}>=({layer,selected,multiSelected,onPointerDown,onNodes,worlds3d=[],views3d=[]})=>{
