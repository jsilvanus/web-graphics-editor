...
export function CanvasLayerContent({ layer, layers = [], selected, selectedIds = new Set(), multiSelected, onPointerDown, onLayerPointerDown, onSelectLayer, onNodes, onTextCommit, onTextRunsCommit, worlds3d = [], views3d = [], currentTime = 0 }: CanvasLayerContentProps): ReactNode {
