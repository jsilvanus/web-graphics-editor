...
export function CanvasLayerContent({ layer, layers = [], selected, selectedIds = new Set(), multiSelected, onPointerDown, onLayerPointerDown, onSelectLayer, onNodes, onTextCommit, worlds3d = [], views3d = [], currentTime = 0 }: CanvasLayerContentProps): ReactNode {
  ...
  if (layer.type === "text") return <TextLayerRenderer layer={layer} layers={layers} onTextCommit={text => onTextCommit?.(layer.id, text)} />;
