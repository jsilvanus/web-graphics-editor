...
export const GraphicsEditorCanvas: FC<{ marquee?: { x: number; y: number; width: number; height: number }; artboardRef: RefObject<HTMLDivElement | null>; layers: Layer[]; selectedIds: Set<string>; grid: boolean; safe: boolean; background: string; zoom?: number; panX?: number; panY?: number; viewportRef?: RefObject<HTMLDivElement | null>; onWheel?: (event: ReactWheelEvent) => void; onViewportPointerDown?: (event: ReactPointerEvent) => void; onViewportPointerMove?: (event: ReactPointerEvent) => void; onViewportPointerUp?: () => void; onFit?: () => void; onZoomIn?: () => void; onZoomOut?: () => void; onZoomReset?: () => void; onPointerMove: (event: ReactPointerEvent) => void; onPointerUp: () => void; onCanvasPointerDown: (event: ReactPointerEvent) => void; onLayerPointerDown: (event: ReactPointerEvent, id: string, kind: "move" | "resize" | "rotate", handle?: string) => void; onSelectLayer?: (id: string, additive?: boolean) => void; onPathNodes?: (id: string, nodes: PathNode[]) => void; onTextCommit?: (id: string, text: string) => void; onTextRunsCommit?: (id: string, runs: TextRun[] | undefined) => void; drawing?: DrawingPreview | null; onDrawingDoubleClick?: () => void; worlds3d?: Graphics3DWorld[]; views3d?: Graphics3DView[]; currentTime?: number }> = ({ artboardRef, layers, selectedIds, grid, safe, background, zoom = 1, panX = 0, panY = 0, viewportRef, onWheel, onViewportPointerDown, onViewportPointerMove, onViewportPointerUp, onFit, onZoomIn, onZoomOut, onZoomReset, onPointerMove, onPointerUp, onCanvasPointerDown, onLayerPointerDown, onSelectLayer, onPathNodes, onTextCommit, onTextRunsCommit, drawing, onDrawingDoubleClick, worlds3d = [], views3d = [], currentTime = 0 }) => {
