...
import type { GraphicsEditorProps, GraphicsDocument, PathCommand } from "./types";
...
export function GraphicsEditor({ document: initialDocument, assets = [], onChange }: GraphicsEditorProps) {
  ...
  const [activeTool, setActiveTool] = useState<"select" | "line" | "path" | "orthogonal">("select");
