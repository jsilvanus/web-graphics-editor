...
const base = (): GraphicsDocument => ({
  ...
  assets: [
    { id: "font", name: "Inter", url: "data:font/woff2;base64,AA==", type: "font" },
    { id: "texture", name: "Texture", url: "data:image/png;base64,AA==", type: "image" },
  ],
  worlds3d: [
    {
      id: "world",
      meshes: [
        {
          ...
          material: { textureAssetId: "texture" },
        },
      ],
  ...
  timeline: {
    scenes: [{ id: "scene", name: "Scene", compositionId: "main", start: 0, duration: 10 }],
  ...
  outputs: [
    { id: "output", name: "Output", viewportId: "program", playback: "static", background: "opaque" },
  ],
});
