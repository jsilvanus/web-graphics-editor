...
export type LayerType="text"|"image"|"video"|"composition"|"rectangle"|"ellipse"|"line"|"path"|"group"|"3d-view";
...
export interface Layer{id:string;name?:string;type:LayerType;x:number;y:number;width:number;height:number;rotation?:number;skewX?:number;skewY?:number;transformOrigin?:Point;opacity?:number;visible?:boolean;locked?:boolean;text?:string;textRuns?:TextRun[];src?:string;path?:string;pathCommands?:PathCommand[];nodes?:PathNode[];closed?:boolean;children?:string[];parentId?:string;animation?:string;style?:Record<string,string|number>;gradient?:Gradient;textStyle?:{fontFamily?:string;fontSize?:number;fontWeight?:number|string;fontStyle?:"normal"|"italic";textAlign?:TextAlign;verticalAlign?:VerticalAlign;lineHeight?:number|string;letterSpacing?:number|string;whiteSpace?:"nowrap"|"pre-wrap";wrap?:"none"|"word"|"character";overflow?:TextOverflow;fontAssetId?:string};view3dId?:string;compositionId?:string;compositionIn?:number;compositionOut?:number;videoAssetId?:string;sourceOut?:number;timeOffset?:number;playbackRate?:number;loop?:boolean;viewportOverrides?:Record<string,ViewportOverride>;provenance?:Provenance}
export interface CompositionTimeline{tracks:AnimationTrack[]}
export interface Composition{id:string;name:string;layerIds:string[];duration?:number;loop?:boolean;timeline?:CompositionTimeline;provenance?:Provenance}
