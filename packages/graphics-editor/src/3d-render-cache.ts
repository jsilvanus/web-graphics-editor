...
export function create3DRenderCacheKey(world:Graphics3DWorld,camera:Graphics3DCamera,view:Graphics3DView,width:number,height:number,pixelRatio:number):string{return stable({world,camera,visibility:view.visibility,width,height,pixelRatio});}
