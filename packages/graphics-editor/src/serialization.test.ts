...
describe("document serialization",()=>{
 ...
 it("produces deterministic serialization across a round-trip",()=>{const doc=baseDocument();const first=serializeGraphicsDocument(doc);const roundTripped=deserializeGraphicsDocument(first);expect(serializeGraphicsDocument(roundTripped)).toBe(first);});
