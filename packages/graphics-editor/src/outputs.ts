...
export function createOutput(name="Output",viewportId?:string):GraphicsOutput{return{id:id("output"),name,viewportId,playback:"static",background:"transparent",editable:true,liveControl:true,defaultTime:0,createdAt:now(),updatedAt:now()}};
...
export function outputViewportId(output:GraphicsOutput){return output.viewportId}
