  ...
  return (
    <main>
      <header>
        ...
        <p>Standalone demo of the reusable graphics editor package.</p>
      </header>
      <GraphicsEditor document={document} onChange={setDocument} />
      <section>
        <h2>3D World Workspace</h2>
        <p>
          Edit arbitrary mesh objects with a separate editor camera, then use stored cameras for composition
          later.
        </p>
        <ThreeDWorkspace world={world} onChange={setWorld} />
      </section>
      <details>
